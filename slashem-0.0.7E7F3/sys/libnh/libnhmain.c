...
js_constants_init(void)
{
    ...
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_CHARACTERISTICS);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_RESET);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_FLUSH);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_TITLE);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_STR);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_DX);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_CO);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_IN);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_WI);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_CH);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_ALIGN);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_SCORE);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_CAP);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_GOLD);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_ENE);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_ENEMAX);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_XP);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_AC);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_HD);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_TIME);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_HUNGER);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_HP);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_HPMAX);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_LEVELDESC);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_EXP);
    SET_CONSTANT("STATUS_FIELD", SHIM_BL_CONDITION);
    SET_CONSTANT("STATUS_FIELD", SHIM_MAXBLSTATS);
    ...
    SET_CONSTANT("OBJECT", NUM_OBJECTS);
    SET_CONSTANT("OBJECT", GEM_CLASS);
    SET_CONSTANT("OBJECT", LAST_GEM);
    SET_CONSTANT("OBJECT", ROCK);
